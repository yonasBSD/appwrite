...
use Appwrite\Insights\CTA\Action\Databases\Indexes\Create as DatabasesIndexesCreate;
...
$register->set('insightCTARegistry', function () {
    ...
    $registry->set(DatabasesIndexesCreate::getName(), fn () => new DatabasesIndexesCreate());
    return $registry;
});
